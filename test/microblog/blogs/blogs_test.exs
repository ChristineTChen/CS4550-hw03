defmodule Microblog.BlogsTest do
  use Microblog.DataCase

  alias Microblog.Blogs

  describe "posts" do
    alias Microblog.Blogs.Post

    @valid_attrs %{authorId: "some authorId", content: "some content", date: "2010-04-17 14:00:00.000000Z", postId: 42, title: "some title"}
    @update_attrs %{authorId: "some updated authorId", content: "some updated content", date: "2011-05-18 15:01:01.000000Z", postId: 43, title: "some updated title"}
    @invalid_attrs %{authorId: nil, content: nil, date: nil, postId: nil, title: nil}
